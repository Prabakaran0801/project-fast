        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {jobs.length === 0 ? (
              <Card className="border-dashed border-zinc-800 bg-[#121214]">
                <CardContent className="p-8 text-center text-sm font-mono text-zinc-500">
                  No history yet. Set <code className="px-1.5 py-0.5 bg-zinc-800 text-white rounded">DATABASE_URL</code> and create your first detection on the homepage.
                </CardContent>
              </Card>
            ) : (
              jobs.map((job) => (
          ...
          <div>
            <Card className="bg-[#121214] border-zinc-800">
              <CardHeader>
                <CardTitle className="text-sm text-white">Recent Transfers</CardTitle>
              </CardHeader>
            ...
            <Card className="mt-4 border-dashed border-zinc-800 bg-transparent">
              <CardContent className="p-4 text-xs font-mono text-zinc-500 leading-5">
                <strong className="text-white">Industrial brutalist UI</strong> for data tables — monospace, rigid grid, terminal aesthetic. Applied here for history view.
              </CardContent>
            </Card>
          </div>
        </div>
